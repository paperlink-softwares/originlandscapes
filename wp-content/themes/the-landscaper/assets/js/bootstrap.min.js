! function() {
    ...
    ! function(o) {
        ...
        function s(t, e) {
            var i, o, n, s, r, a, l, p, h, c, u, d = e && e.split("/"),
                f = b.map,
                g = f && f["*"] || {};
            if (t && "." === t.charAt(0))
                if (e) {
                    for (t = t.split("/"), r = t.length - 1, b.nodeIdCompat && T.test(t[r]) && (t[r] = t[r].replace(T, "")), t = d.slice(0, d.length - 1).concat(t), h = 0; h < t.length; h += 1)
            ...
            if ((d || g) && f) {
                for (i = t.split("/"), h = i.length; h > 0; h -= 1) {
                    ...
                    if (s) break;
                    !l && g && g[o] && (l = g[o], p = h)
                }!s && l && (s = l, a = p), s && (i.splice(0, a, s), t = i.join("/"))
            }
            return t
        }
        ...
        function r(t, e) {
            return function() {
                ...
                return "string" != typeof i[0] && 1 === i.length && i.push(null), d.apply(o, i.concat([t, e]))
            }
        }
        ...
        f = function(t, e) {
            var i, o = h(t),
                n = o[0];
            return t = o[1], n && (n = s(n, e), i = p(n)), n ? t = i && i.normalize ? i.normalize(t, a(e)) : s(t, e) : (t = s(t, e), o = h(t), n = o[0], t = o[1], n && (i = p(n))), {
                f: n ? n + "!" + t : t,
                n: t,
                pr: n,
                p: i
            ...
            if (s = s || t, "undefined" === $ || "function" === $) {
                for (e = !e.length && i.length ? ["require", "exports", "module"] : e, d = 0; d < e.length; d += 1)
                    if (u = f(e[d], s), h = u.f, "require" === h) w[d] = g.require(t);
                ...
                c = i ? i.apply(m[t], w) : void 0, t && (a && a.exports !== o && a.exports !== m[t] ? m[t] = a.exports : c === o && b || (m[t] = c))
            } else t && (m[t] = i)
            ...
            return e = e || function() {}, "function" == typeof i && (i = n, n = s), n ? u(o, t, e, i) : setTimeout(function() {
                u(o, t, e, i)
            }, 4), d
        }, d.config = function(t) {
            return d(t)
            ...
            e.splice || (i = e, e = []), n(m, t) || n(v, t) || (v[t] = [t, e, i])
        }, i.amd = {
            jQuery: !0
        }
        ...
        i.VERSION = "3.4.1", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
            ...
            if (this.$element.trigger(h), !h.isDefaultPrevented()) {
                ...
                return t.support.transition && this.$element.hasClass("slide") ? (s.addClass(e), "object" == typeof s && s.length && s[0].offsetWidth, n.addClass(a), s.addClass(a), n.one("bsTransitionEnd", function() {
    ...
    }(jQuery), i("bootstrapCarousel", ["jquery"], function() {}), + function(t) {
        "use strict";
        ...
        function e(e, i) {
            ...
            if (-1 !== t.inArray(o, i)) return -1 !== t.inArray(o, s) ? Boolean(e.nodeValue.match(l) || e.nodeValue.match(p)) : !0;
            ...
            for (var r = t.map(o, function(t, e) {
                ...
                if (-1 !== t.inArray(c, r))
                    for (var u = t.map(h.attributes, function(t) {
                            return t
                        }), d = [].concat(o["*"] || [], o[c] || []), f = 0, g = u.length; g > f; f++) e(u[f], d) || h.removeAttribute(u[f].nodeName);
        ...
        h.VERSION = "3.4.1", h.TRANSITION_DURATION = 150, h.DEFAULTS = {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (l) {
                    ...
                    r = "bottom" == r && p.bottom + u > f.bottom ? "top" : "top" == r && p.top - u < f.top ? "bottom" : "right" == r && p.right + c > f.width ? "left" : "left" == r && p.left - c < f.left ? "right" : r, n.removeClass(d).addClass(r)
                }
    ...
    }), e(["bootstrapCarousel", "bootstrapCollapse", "bootstrapTooltip"]), i("assets/js/bootstrap", function() {})
}();